...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_CHROME_BRIDGE_EXTENSION_ID</code></td><td>Allow only one Chrome extension id to connect to the bridge daemon.</td><td>Any local bridge extension</td></tr>
